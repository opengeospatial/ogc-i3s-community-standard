:Title: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package Format Version 1.3 Release Notes
:titletext: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package Format Version 1.3 Release Notes
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Submission Date: 2022-xx-xx
|Approval Date:   2022-xx-xx
|Publication Date:   2022-xx-xx
|External identifier of this OGC(R) document: http://www.opengis.net/doc/NOTE/I3S-notes/1.3
|Internal reference number of this OGC(R) document:    22-xxx
|Version: 1.3
