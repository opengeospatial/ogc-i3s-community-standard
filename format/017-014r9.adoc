...
:titletext: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package (*.slpk) Format Community Standard Version 1.3
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Approval Date:   2022-12-10
|Publication Date:   2022-12-30
|External identifier of this OGC(R) document: http://www.opengis.net/doc/CS/i3s/1.3
|Internal reference number of this OGC(R) document:    17-014r9
|Version: 1.3
