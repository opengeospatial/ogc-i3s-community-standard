...
The following table lists the I3S Media Types. Currently, these media types are only use in the Point Scene Layer and the Point Cloud Scene Layer profiles. This table can be extended as required.
