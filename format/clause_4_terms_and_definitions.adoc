...
=== *Bounding Volume (BV)* [note14,https://en.wikipedia.org/wiki/Bounding_volume (February 19, 2021)]
...
=== *Bounding Volume Hierarchy (BVH)* [note15,https://en.wikipedia.org/wiki/Bounding_volume_hierarchy (February 19, 2021)]
