:Title: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package (*.slpk) Format Community Standard
:titletext: OGC Indexed 3d Scene Layer (I3S) and Scene Layer Package (*.slpk) Format Community Standard
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Version: 1.2
|Category: OGC(R) <Implementation / Abstract Specification / Best Practice>
