...
The original I3S Specification originated from investigations into technologies for rapidly
...
Both formats are encoded using JSON and binary ArrayBuffers (https://262.ecma-international.org/6.0/[ECMAScript
...
* To stream large 3D datasets 
* For performance and scalability. 
* To support 3D geospatial content. 
* To support the requisite coordinate reference systems (CRS) and height models.
* Support a rich set of layer types.
...
NOTE: The OGC I3S source content can be found and viewed https://github.com/opengeospatial/ogc-i3s-community-standard[here]. If you wish to suggest changes, please create a branch. However, given that the Esri I3S Git repository is the source of the normative content, please also coordinate with the Esri I3S team.
