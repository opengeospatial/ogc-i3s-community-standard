...
image:../docs/images/MBS_Example.png[width=800,align="center"]

_3D objects enclosed in the smallest bounding box._
image:../docs/images/OBB_Example.png[width=800,align="center"]
...
image:../docs/images/BoundingVolumeHierarchy.png[width=800,align="center"]
