...
https://github.com/opengeospatial/ogc-i3s-community-standard/tree/main/docs/1.6IntegratedMesh_ReadMe.adoc[Integrated Mesh], +
https://github.com/opengeospatial/ogc-i3s-community-standard/tree/main/docs/1.6Point_ReadMe.adoc[Points].
