...
image:../docs/image/MBS_Example.png[Minimum bounding sphere..]

_3D objects enclosed in minimum bounding spheres._

image:../docs/image/OBB_Example.png[Oriented bounding box.]
...
image:../docs/image/BoundingVolumeHierarchy.png[Create bounding volume
hierarchy.]
