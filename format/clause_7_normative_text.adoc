...
See link:../docs/3dSceneLayerInfo.cmn.adoc[Class 3dSceneLayerInfo] (Formerly Clause 7.5.4 in version 1.1) for more information on the use of the heightModelInfo object.
