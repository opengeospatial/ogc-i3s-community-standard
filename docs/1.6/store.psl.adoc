...
Documents. Example: application/vnd.ogc.I3S.json+gzip; version=1.1.
...
Geometry Resources. For example: application/octet-stream; version=1.1.

|attributeEncoding |string |MIME type for the encoding used for the
Attribute Resources. For example: application/octet-stream; version=1.1.
...
----
 {
  ...
  "nidEncoding": "application/vnd.ogc.i3s.json+gzip; version=1.1",
  "featureEncoding": "application/vnd.ogc.i3s.json+gzip; version=1.1",
  "geometryEncoding": "application/octet-stream; version=1.1",
  "attributeEncoding": "application/octet-stream; version=1.1",
  "textureEncoding": [
    "image/jpeg",
    "image/vnd-ms.dds"
  ],
