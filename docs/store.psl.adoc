...
Documents. Example: application/vnd.ogc.I3S.json+gzip; version=1.3.
...
----
 {
  ...
  "nidEncoding": "application/vnd.ogc.i3s.json+gzip; version=1.3",
  "featureEncoding": "application/vnd.ogc.i3s.json+gzip; version=1.3",
  "geometryEncoding": "application/octet-stream; version=1.3",
