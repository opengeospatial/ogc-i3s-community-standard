...
The drawingInfo object contains drawing information for a point cloud scene layer. This is a restricted instance of the common link:drawingInfo.cmn.adoc[cmn:drawingInfo]
