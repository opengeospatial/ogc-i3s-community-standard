...
|parentNode |link:nodeReference.cmn.md[nodeReference] |Reference to the
parent node of a node.

|children |link:nodeReference.cmn.md[nodeReference][] |Reference to the
child nodes of a node.

|neighbors |link:nodeReference.cmn.md[nodeReference][] |Reference to the
