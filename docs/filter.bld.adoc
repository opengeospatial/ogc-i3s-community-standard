...
The filter object can be applied to a building scene layer. Filter rules defined in a Filter object enable client applications to display only elements of a building based on specific types and values, such as specific catgories.
